...
echo "  4. (optional) Multi-zone music + Spotify Connect — see docs/MUSIC_SETUP.md"
echo "  5. (optional) Intercom — needs HTTPS for phone mics, see docs/INTERCOM_SETUP.md"
