 ...
 * accidentally delete a family member or a bank account otherwise, especially on a touchscreen.
 * Expands in place rather than a full modal, to stay quick for the common "yes I meant it" case.
 */
export function ConfirmButton({ label, confirmLabel, onConfirm, className = 'link-button' }: Props) {
